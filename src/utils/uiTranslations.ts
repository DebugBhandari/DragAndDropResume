...
const UI_TEXT: Record<LocaleCode, UiText> = {
  en: {
    ...
    settings: 'Asetukset', sections: 'Osiot', introduction: 'Johdanto', addToResume: 'Lisaa CV:hen',
    ...
    styleHeader: 'Otsikko', styleBody: 'Sisalto', styleAccentColor: 'Korostusvari', styleFontSize: 'Fonttikoko',
  ...
  sv: {
    ...
    settings: 'Installningar', sections: 'Sektioner', introduction: 'Introduktion', addToResume: 'Lagg till i CV',
    ...
    styleBody: 'Innehall', styleAccentColor: 'Accentfarg', styleFontSize: 'Teckenstorlek',
  ...
  es: {
    ...
    settings: 'Configuracion', sections: 'Secciones', introduction: 'Introduccion', addToResume: 'Agregar al CV',
    ...
    styleBody: 'Cuerpo', styleAccentColor: 'Color de acento', styleFontSize: 'Tamano de fuente',
  ...
  de: {
    ...
    settings: 'Einstellungen', sections: 'Abschnitte', introduction: 'Einleitung', addToResume: 'Zum Lebenslauf hinzufugen',
    ...
    styleBody: 'Inhalt', styleAccentColor: 'Akzentfarbe', styleFontSize: 'Schriftgroesse',
  ...
  fr: {
    ...
    settings: 'Parametres', sections: 'Sections', introduction: 'Introduction', addToResume: 'Ajouter au CV',
    ...
    styleBody: 'Corps', styleAccentColor: 'Couleur d accent', styleFontSize: 'Taille de police',
  ...
  ne: {
    ...
    settings: 'सेटिङ्स', sections: 'सेक्सनहरू', introduction: 'परिचय', addToResume: 'रिज्युमेमा थप्नुहोस्',
    ...
    styleAccentColor: 'मुख्य रङ', styleFontSize: 'फन्ट साइज', styleHeaderAlignment: 'हेडर मिलान',
  ...
  zh: {
    ...
    settings: '设置', sections: '版块', introduction: '介绍', addToResume: '添加到简历', language: '语言',
    ...
    styleAccentColor: '主题色', styleFontSize: '字体大小', styleHeaderAlignment: '页眉对齐', styleHeadingSize: '标题大小',
  ...
  ja: {
    ...
    settings: '設定', sections: 'セクション', introduction: '紹介', addToResume: '履歴書に追加', language: '言語',
    ...
    styleAccentColor: 'アクセントカラー', styleFontSize: 'フォントサイズ', styleHeaderAlignment: 'ヘッダーの配置',
