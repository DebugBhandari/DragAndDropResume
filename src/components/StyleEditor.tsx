...
export default function StyleEditor() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="text-xs font-medium text-gray-600 block mb-1">Icons</label>
      ...
      <div>
        <label className="text-xs font-medium text-gray-600 block mb-1">Header Alignment</label>
        <div className="flex gap-2">
      ...
      <div>
        <label className="text-xs font-medium text-gray-600 block mb-1">Heading Size</label>
        <div className="flex gap-2">
          {(['sm', 'md', 'lg'] as const).map((s) => (
      ...
      <div>
        <label className="text-xs font-medium text-gray-600 block mb-1">Section Spacing</label>
        <div className="flex gap-2">
